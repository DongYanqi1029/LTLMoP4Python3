...
class ROSLauncherWithParams(object):
    def __init__(self, rospackage_name, launch_file_name, params, ros_ws_abspath="/home/user/simulation_ws"):
        self._rospackage_name = rospackage_name
        self._launch_file_name = launch_file_name
        self._params = params
