...
class SimGUI_Frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.executorProxy = xmlrpc.client.ServerProxy("http://127.0.0.1:{}".format(executor_port), allow_none=True)
    ...
    def __do_layout(self):
        ...
        sizer_43_copy_1.Add(self.button_sim_startPause, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_HORIZONTAL, 20)
        sizer_43_copy_1.Add((20, 10), 0, 0, 0)
        sizer_43_copy_1.Add(self.button_sim_log_clear, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_HORIZONTAL, 20)
        sizer_43_copy_1.Add((20, 10), 0, 0, 0)
        sizer_43_copy_1.Add(self.button_sim_log_export, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_HORIZONTAL, 20)
        sizer_43_copy_1.Add((20, 10), 0, 0, 0)
        ...
        self.window_1.SetSashPosition(int(self.GetSize().y/2))
    ...
    def onResize(self, event=None): # wxGlade: SimGUI_Frame.<event_handler>
        ...
        self.mapBitmap = wx.Bitmap(size.x, size.y)
    ...
    def appendLog(self, text, color="BLACK"):
        ...
        for p_reg in set(re.findall(r'\b(p\d+)\b',text)):
            for rname, subregs in self.proj.regionMapping.items():
                if p_reg in subregs:
                    break
    ...
    def saveFile(self, fileName):
        ...
        print("Experiment Status Log", file=f)
        print(file=f)
        # write the log
        print(str(self.text_ctrl_sim_log.GetValue()), file=f)
