...
import time
import threading, _thread, subprocess
import roslib
...
class RosActuatorHandler(handlerTemplates.ActuatorHandler):
    ...
    def simpleAction(self, actuatorVal, initial=False):
        """
        This is a simple example for actions handler
