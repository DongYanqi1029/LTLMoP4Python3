...
sys.path.append(os.path.join(p,"src","StrategyInterpreter"))
...
class HandlerSubsystem:
    ...
    def _getSubdirectories(self, path):
        ...
        Only goes one level.
        """
        abs_path = os.path.join(get_ltlmop_root(), path)
    ...
    def loadAllHandlers(self):
        ...
        for folder in handler_folders:
            for handler_file in os.listdir(os.path.join(get_ltlmop_root(), folder)):
                abs_path = os.path.join(get_ltlmop_root(), folder, handler_file)
    ...
    def loadHandler(self, r_type, h_type, h_name):
        ...
        # logging.warning(handler_config)
        # print("handlerSubsystem.py")
    ...
    def getHandlerConfigDefault(self, r_type, h_type, h_name):
        ...
        # logging.warning(self.handler_configs)
        # logging.warning(r_type)
        # logging.warning(h_type)
        # logging.warning(h_name)
        ...
        if self.handler_configs == {}:
            ...
            if r_type not in self.handler_configs.keys():
                ...
                # logging.warning(self.handler_configs.keys())
    ...
    def setExecutingConfig(self, config_object_name):
        ...
        # logging.warning(self.executing_config)
    ...
    def prepareMapping(self):
        ...
        for prop_name, func_string in mapping.items():
...
if __name__ == '__main__':
    ...
    filename = os.path.join(get_ltlmop_root(), "examples", "firefighting", "firefighting.spec")
