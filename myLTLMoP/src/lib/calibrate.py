...
from numpy import *
import mapRenderer
from lib._transformations import affine_matrix_from_points
...
class CalibrateFrame(wx.Frame):
    ...
    def doCalibration(self):
        ...
        if self.configEditorPort is None:
            ...
            UDPSock.sendto(output.encode(), self.configEditorPort)
            UDPSock.close()
    ...
    def onButtonGo(self, event): # wxGlade: CalibrateFrame.<event_handler>
        try:
            self.calibrationWizard.__next__()
